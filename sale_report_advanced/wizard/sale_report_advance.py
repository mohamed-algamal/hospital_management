...
class SaleReportAdvance(models.TransientModel):
    ...
    def action_get_excel_report(self):
        datas = self._get_data()
        return self.env.ref('sale_report_advanced.action_sale_advance_report_xlsx').report_action([], data=datas)


class SaleAdvanceReportXlsx(models.AbstractModel):
    _name = 'report.sale_report_advanced.report_sale_advance_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        loaded_data = data
        sheet = workbook.add_worksheet("Sales Profit Report")
        cell_format = workbook.add_format({
            'font_size': 12,'align': 'left', 'valign': 'vcenter', 'bold': True, 'font_color': '#333333',
        })
        head = workbook.add_format({
            'font_size': 18, 'bold': True, 'align': 'center', 'valign': 'vcenter', 'font_color': '#1F4E78',
        })
        ...
        format2 = workbook.add_format({
            'font_size': 11, 'align': 'center', 'valign': 'vcenter', 'bold': True,'bg_color': '#4F81BD',
            'font_color': 'white', 'border': 1,
        })
        # Sub-header / grouped row
        format3 = workbook.add_format({
            'font_size': 11, 'align': 'center', 'valign': 'vcenter', 'bold': True, 'bg_color': '#D9E1F2', 'border': 1,
        })
        # Normal data cells
        format1 = workbook.add_format({
            'font_size': 10, 'align': 'center', 'valign': 'vcenter', 'bg_color': '#EFF6FF', 'border': 1,
        })
        # Totals row
        format4 = workbook.add_format({'font_size': 10, 'align': 'center', 'valign': 'vcenter', 'bold': True,
