...
class SaleReportInvoice(models.TransientModel):
    ...
    def action_get_excel_invoice_report(self):
        ...
        datas = self._get_data()
        return self.env.ref('sale_report_advanced.action_sale_invoice_report_xlsx').report_action([], data=datas)

class SaleInvoiceReportXlsx(models.AbstractModel):
    _name = 'report.sale_report_advanced.report_sale_invoice_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        format1 = workbook.add_format({'font_size': 10, 'align': 'left', 'bg_color': '#bbd5fc', 'border': 1})
        format4 = workbook.add_format({'font_size': 10, 'align': 'center', 'bg_color': '#bbd5fc', 'border': 1})
