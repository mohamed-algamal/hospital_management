...
class SaleReportWeekly(models.TransientModel):
    ...
    def action_get_excel_weekly_report(self):
        ...
        weekly report."""
        datas = self._get_data()
        return self.env.ref('sale_report_advanced.action_sale_weekly_report_xlsx').report_action([], data=datas)

class SaleWeeklyReportXlsx(models.AbstractModel):
    _name = 'report.sale_report_advanced.report_sale_weekly_xlsx'
