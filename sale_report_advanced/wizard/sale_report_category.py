...
class SaleReportCategory(models.TransientModel):
    ...
    def action_get_excel_category_report(self):
        ...
        datas = self._get_data()
        return self.env.ref('sale_report_advanced.action_sale_category_report_xlsx').report_action([], data=datas)

class SaleCategoryReportXlsx(models.AbstractModel):
    _name = 'report.sale_report_advanced.report_sale_category_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        """ Generate an Excel category-based sales report."""
        loaded_data = data
        sheet = workbook.add_worksheet("Sales category Report")
        ...
        format4 = workbook.add_format({'font_size': 10, 'align': 'center', 'bold': True, 'bg_color': '#c0dbfa'})
